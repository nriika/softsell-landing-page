  ...
  return (
    <div className="relative font-sans bg-white text-gray-800 dark:bg-gray-900 dark:text-white scroll-smooth">
      ...
      <header className="relative bg-gradient-to-r from-blue-600 to-blue-400 text-white text-center min-h-[95vh] flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="absolute top-10 left-12 text-9xl opacity-50 animate-float">💸</div>
        <div className="absolute bottom-12 right-12 text-9xl opacity-50 animate-float animation-delay-2000">🔒</div>

        <div className="relative z-10 flex flex-col items-center">
          <img
            src={logo}
            alt="SoftSell Logo"
            className="w-32 h-32 object-contain mb-6 animate-float rounded-full shadow-[0_12px_32px_rgba(59,130,246,0.4)]"
          />
          <h1 className="text-5xl font-extrabold mb-4 drop-shadow-lg animate-pulse">
            Sell Unused Software Licenses Easily
          </h1>
          <p className="text-xl mb-6">Turn your unused software into cash in 3 simple steps.</p>
          <a href="#contact">
      ...
      <section id="why" className="py-20 px-4 bg-[rgba(229,231,235,0.6)] dark:bg-gray-800 shadow-inner">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center justify-center">
            {["⚡ Fast Process", "🔒 Secure Transactions", "💸 High Payouts", "⭐ Trusted by Users"].map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-white dark:bg-gray-700 rounded-full w-40 h-40 flex flex-col items-center justify-center shadow-lg border border-blue-100 hover:shadow-blue-500 transition hover:scale-105 mx-auto"
                >
                  <div className="text-5xl animate-float-slow mb-1">{icon}</div>
                  <h4 className="font-semibold text-blue-700 dark:text-blue-300 text-sm px-2 leading-tight">{title}</h4>
                </div>
              );
            })}
          </div>
      ...
      <Section title="Get in Touch" id="contact">
        <div className="relative overflow-hidden rounded-xl shadow-2xl p-6 ring-1 ring-gray-200 dark:ring-gray-600 z-10 bg-white dark:bg-gray-800">
          <div className="absolute -left-20 top-1/4 w-96 h-96 bg-blue-400 opacity-50 rounded-full blur-3xl animate-blob -z-10"></div>

          <form className="grid gap-4 md:grid-cols-2 relative z-10">
            ...
            <textarea placeholder="Message" required className="contact-field md:col-span-2"></textarea>
            <button
              type="submit"
              className="bg-blue-600 text-white py-2 px-4 rounded md:col-span-2 hover:bg-blue-700 transition shadow-lg hover:shadow-blue-400"
            >
              Submit
            </button>
          </form>
      ...
      <footer className="bg-[#0d1520] dark:bg-black text-white py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-4xl font-bold text-blue-500">SoftSell</span>
          </div>

          <div>
            <h3 className="text-lg font-bold text-blue-400 mb-4">Links</h3>
            <div className="grid grid-cols-4 gap-y-8 gap-x-8 text-sm">
